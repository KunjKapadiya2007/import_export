        ...
        <Box sx={{padding: {xs: "30px 15px", sm: "50px 20px"}, backgroundColor: "#f9f9f9"}}>
            <Container>
                ...
                <Box sx={{display: "flex", justifyContent: "center"}}>
                    <Typography
                        sx={{
                            margin: {lg:"25px 200px 40px",md:"25px 150px 40px",xs:"25px 0 40px"},
                    ...
                    >
                        Established in March 2014, Ratan House has quickly become a trusted name in the global food
                        industry.
                        With a mission to provide top-quality food services, we have positioned ourselves as leading
                        exporters
